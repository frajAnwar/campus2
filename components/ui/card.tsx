...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        'group/card flex flex-col gap-4 overflow-hidden rounded-xl bg-card text-card-foreground',
        'ring-1 ring-border/50',
        'shadow-[0_1px_2px_-1px_rgb(0_0_0_/_0.03),_0_1px_3px_-2px_rgb(0_0_0_/_0.03)]',
        ...
        hoverable && 'hover:-translate-y-0.5 hover:shadow-[0_10px_15px_-3px_rgb(0_0_0_/_0.04),_0_4px_6px_-4px_rgb(0_0_0_/_0.04)] hover:ring-border',
        className
      )}
      {...props}
    />
